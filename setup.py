...
setup(
    ...
    packages = ['trios', 'trios.feature_extractors', 'trios.classifiers.ISI', 'trios.classifiers', 'trios.v1', 'trios.legacy', 'trios.window_determination', 'trios.shortcuts', 'trios.contrib', 'trios.contrib.staffs']
)
