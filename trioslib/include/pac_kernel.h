#ifndef _pac_kernel_h_
#define _pac_kernel_h_

/* created in Jan 28 2000 */
...
/* =================================================================== *
   ...
   These defines at the beginning must be changed according to
   the environment to be used. In future, we will provide compilation
   scripts that will do the necessary changes automatically.
   (Nina, on April 10, 2001)
