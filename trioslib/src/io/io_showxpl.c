...
int /*+ Purpose: show the elements of an example set + */ lshowxpl(
...
/*  Mod: modifications for implementation of BG and WK types                */
	...
	case BB:
		if (!xpl_show_BB(fd, xpl, win, select_type, from, to)) {
			return pac_error(MSG,
					 "lshowxpl: xpl_show_BB() failed.");
		}
		break;
	...
	case GB:
	default:
		return pac_error(1, "lshowxpl: Type %d is not implemented yet.",
				 map_type);
...
int				/*+ Purpose: write some basic information concerning
				   to a XPL set                                + */ xpl_show_basicinfo(
													      FILE * fd, xpl_t * xpl,	/*+ In: XPL set                                   + */
													      int select_type,	/*+ In: type of examples to be showed
																   1 : All
																   2 : only conflicting ones
																   3 : only non-conflicting ones              + */
...
int /*+ Purpose: write the examples from a BB XPL set to a file + */ xpl_show_BB(
...
int /*+ Purpose: write the examples from a BB XPL set to a file + */ xpl_show_BG(
											FILE * fd,	/*+ In: output file descriptor                   + */
											xpl_t * xpl,	/*+ In: XPL set                                  + */
											window_t * win,	/*+ In: Window                                   + */
											int select_type,	/*+ In: type of examples to be showed
...
int /*+ Purpose: write the examples from a BB XPL set to a file + */ xpl_show_WK(
											FILE * fd,	/*+ In: output file descriptor                   + */
											xpl_t * xpl,	/*+ In: XPL set                                  + */
											window_t * win,	/*+ In: Window                                   + */
											int select_type,	/*+ In: type of examples to be showed
