...
float variance(void)
{
  ...
  if (no_of_categories > 2) {
    ...
    qsort((char *)(left_count+1),no_of_categories,sizeof(int),(qsort_compare_type)var_compare) ;
    qsort((char *)(right_count+1),no_of_categories,sizeof(int),(qsort_compare_type)var_compare) ;
  }
