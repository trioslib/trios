...
int /*+ Purpose: Makes the decision for BB and BG          + */ decide_ll_bb(
...
mtm_t				/*+ Purpose: Builds the mtm table from the examples    + */
    * mtm_decide(xpl_t * xpl,	/*+ In: pointer to examples                            + */
...
mtm_t				/*+ Purpose: Builds a set of classified examples from a set of
    ...
    * decide_other(xpl_t * xpl,	/*+ In: pointer to a set of examples                   + */
...
int				/*+ Purpose: Makes the decision based on an inertia
				   ...
				   conflicting examples                                 + */ decide_ll_bb_other(
